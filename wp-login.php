...
case 'register' :
	...
	if ( $http_post ) {
		...
		if(!is_wp_error($errors))
		{
			...
			{
				update_user_meta($errors, 'user_skype', $_POST['user_skype'], $prev_value);
			}
			
			//$redirect_to = !empty( $_POST['redirect_to'] ) ? $_POST['redirect_to'] : 'wp-login.php?checkemail=registered';
			//wp_safe_redirect( $redirect_to );
			$featured_films_page_id = 24;
			wp_safe_redirect( get_permalink( $featured_films_page_id ) );
			exit();
		}
	}
...
<form name="registerform" id="registerform" action="<?php echo esc_url( site_url( 'wp-login.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
	...
	<p>
		<label for="user_skype"><?php _e('Skype') ?><br />
		<input type="email" name="user_skype" id="user_skype" class="input" value="<?php echo esc_attr( wp_unslash( $user_skype ) ); ?>" size="25" /></label>
	</p>
	<?php
	/**
