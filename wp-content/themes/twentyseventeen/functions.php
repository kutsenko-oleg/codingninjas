...
function create_post_type()	// creates a custom post type
{
	register_post_type( 'films',
		array('labels' => array( 
							...
							'view_item' => __('Просмотр фильма'),
							'search_items' => __('Поиск фильма'),
							'not_found' => __('Нет фильмов'),
							'not_found_in_trash' => __('фильмы не найдены'), 
							'menu_name' => 'Фильмы'
						), 
		'public' => true, 
		'menu_position' => 5,
...
function add_custom_user_profile_fields($user)	// this function shows a custom field "skype"
{
?>
	<h3><?php _e('Extra Profile Information', 'twentyseventeen'); ?></h3>
	
	<table class="form-table">
		<tr>
			<th><label for="user_skype"><?php _e('Skype', 'twentyseventeen'); ?></label></th>
			<td>
				...
				<p class="description"><?php _e('Please enter your skype id', 'twentyseventeen'); ?></p>
			</td>
		</tr>
	</table>
<?php }
...
add_action('show_user_profile', 'add_custom_user_profile_fields');	// to display a custom field "skype" in admin area
add_action('edit_user_profile', 'add_custom_user_profile_fields');

add_action('personal_options_update', 'save_custom_user_profile_fields');	// to save a custom field "skype" in admin area
add_action('edit_user_profile_update', 'save_custom_user_profile_fields');

add_action('woocommerce_save_account_details', 'save_custom_user_profile_fields');	// to save a custom fields "skype" at the Woocommerce account page
